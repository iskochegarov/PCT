...
plot "1m1k.dat" using 1:2 title "N = 10^6" with linespoints ls 1,\
     "10m1k.dat" using 1:2 title "N = 10^7" with linespoints ls 2,\
     "100m1k.dat" using 1:2 title "N = 10^8" with linespoints ls 3,\
