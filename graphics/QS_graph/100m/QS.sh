...
plot "100m1k.dat" using 1:2 title "Threashold = 1000" with linespoints ls 1,\
     "100m5k.dat" using 1:2 title "Threashold = 5000" with linespoints ls 2,\
     "100m10k.dat" using 1:2 title "Threashold = 10000" with linespoints ls 3,\
